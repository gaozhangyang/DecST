...
def create_parser():
    ...
    parser.add_argument('--gpu', default=5, type=int) # user change 指定训练模型的gpu,如：[0],[0,1],[0,1,2]
    ...
    parser.add_argument('--data_root',default='/usr/data/video_dataset/data/kth_action/')
    parser.add_argument('--dataname',default='kth')
    parser.add_argument('--pre_seq_length', default=10)
    parser.add_argument('--aft_seq_length', default=20)

    # model parameters # TODO
    parser.add_argument('--method',default='gST',choices=['gST'])
    parser.add_argument('--in_shape',default=[10,1,128,128],type=int,nargs='*')
